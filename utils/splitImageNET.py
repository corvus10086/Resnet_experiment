...
train_csv_path = "../dataset/mini-imagenet/train.csv"
val_csv_path = "../dataset/mini-imagenet/val.csv"
test_csv_path = "../dataset/mini-imagenet/test.csv"
...
img_path = "../dataset/mini-imagenet/images"
new_img_path = "../dataset/mini-imagenet/images-new"
