...
from utils.readData import read_cifar10_dataset
...
# 读数据
batch_size = 50
train_loader, valid_loader, test_loader = read_cifar10_dataset(batch_size=batch_size, pic_path='dataset')
...
# model.fc = torch.nn.Linear(512*4, n_class)  # 将最后的全连接层改掉
...
for epoch in tqdm(range(1, n_epochs + 1)):
    ...
    if valid_loss <= valid_loss_min:
        ...
        torch.save(model.state_dict(), 'checkpoint/resnet101_cifar10.pt')
