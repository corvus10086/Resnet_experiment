...
from utils.readData import read_mini_image_net_dataset
from utils.plain import Plain18

# set device
device = 'cuda' if torch.cuda.is_available() else 'cpu'
# 读数据
batch_size = 64
train_loader, valid_loader, test_loader = read_mini_image_net_dataset(batch_size=batch_size, pic_path='dataset')
...
for epoch in tqdm(range(1, n_epochs + 1)):
    ...
    if valid_loss <= valid_loss_min:
        ...
        torch.save(model.state_dict(), 'checkpoint/plain18_imageNet.pt')
